...
func (r TaskSchedulesAPITaskSchedulesListRequest) PrnIn(prnIn []string) TaskSchedulesAPITaskSchedulesListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (a *TaskSchedulesAPIService) TaskSchedulesListExecute(r TaskSchedulesAPITaskSchedulesListRequest) (*PaginatedTaskScheduleResponseList, *http.Response, error) {
	...
	if r.taskNameContains != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "task_name__contains", r.taskNameContains, "form", "")
	}
	if r.fields != nil {
		t := *r.fields
