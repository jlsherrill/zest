...
type RepositoriesPythonAPIRepositoriesPythonPythonAddRoleRequest struct {
	ctx context.Context
...
func (r RepositoriesPythonAPIRepositoriesPythonPythonAddRoleRequest) Execute() (*NestedRoleResponse, *http.Response, error) {
	return r.ApiService.RepositoriesPythonPythonAddRoleExecute(r)
}

/*
RepositoriesPythonPythonAddRole Add a role

Add a role for this object to users/groups.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pythonPythonRepositoryHref
 @return RepositoriesPythonAPIRepositoriesPythonPythonAddRoleRequest
*/
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonAddRole(ctx context.Context, pythonPythonRepositoryHref string) RepositoriesPythonAPIRepositoriesPythonPythonAddRoleRequest {
	return RepositoriesPythonAPIRepositoriesPythonPythonAddRoleRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonAddRoleExecute(r RepositoriesPythonAPIRepositoriesPythonPythonAddRoleRequest) (*NestedRoleResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoriesPythonAPIService.RepositoriesPythonPythonAddRole")
	if err != nil {
...
PythonRepository represents a single Python repository, to which content can besynced, added, or removed.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pulpDomain
 @return RepositoriesPythonAPIRepositoriesPythonPythonCreateRequest
*/
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonCreate(ctx context.Context, pulpDomain string) RepositoriesPythonAPIRepositoriesPythonPythonCreateRequest {
	return RepositoriesPythonAPIRepositoriesPythonPythonCreateRequest{
		ApiService: a,
		ctx: ctx,
...
// Filter results where name matches value
func (r RepositoriesPythonAPIRepositoriesPythonPythonListRequest) NameIexact(nameIexact string) RepositoriesPythonAPIRepositoriesPythonPythonListRequest {
...
func (r RepositoriesPythonAPIRepositoriesPythonPythonListRequest) NameIregex(nameIregex string) RepositoriesPythonAPIRepositoriesPythonPythonListRequest {
	r.nameIregex = &nameIregex
	return r
}

// Filter results where name starts with value
func (r RepositoriesPythonAPIRepositoriesPythonPythonListRequest) NameIstartswith(nameIstartswith string) RepositoriesPythonAPIRepositoriesPythonPythonListRequest {
	r.nameIstartswith = &nameIstartswith
	return r
}

// Filter results where name matches regex value
func (r RepositoriesPythonAPIRepositoriesPythonPythonListRequest) NameRegex(nameRegex string) RepositoriesPythonAPIRepositoriesPythonPythonListRequest {
...
*/
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonList(ctx context.Context, pulpDomain string) RepositoriesPythonAPIRepositoriesPythonPythonListRequest {
	return RepositoriesPythonAPIRepositoriesPythonPythonListRequest{
		ApiService: a,
		ctx: ctx,
		pulpDomain: pulpDomain,
...
type RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest struct {
	ctx context.Context
	ApiService *RepositoriesPythonAPIService
	pythonPythonRepositoryHref string
	xTaskDiagnostics *[]string
...
// A list of fields to include in the response.
func (r RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest) Fields(fields []string) RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest {
	r.fields = &fields
	return r
}

// A list of fields to exclude from the response.
func (r RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest) ExcludeFields(excludeFields []string) RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest {
	r.excludeFields = &excludeFields
	return r
}

func (r RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest) Execute() (*ObjectRolesResponse, *http.Response, error) {
	return r.ApiService.RepositoriesPythonPythonListRolesExecute(r)
}

/*
RepositoriesPythonPythonListRoles List roles

List roles assigned to this object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pythonPythonRepositoryHref
 @return RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest
*/
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonListRoles(ctx context.Context, pythonPythonRepositoryHref string) RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest {
	return RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest{
		ApiService: a,
		ctx: ctx,
		pythonPythonRepositoryHref: pythonPythonRepositoryHref,
...
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonListRolesExecute(r RepositoriesPythonAPIRepositoriesPythonPythonListRolesRequest) (*ObjectRolesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoriesPythonAPIService.RepositoriesPythonPythonListRoles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest struct {
	ctx context.Context
	ApiService *RepositoriesPythonAPIService
	pythonPythonRepositoryHref string
	xTaskDiagnostics *[]string
...
// A list of fields to include in the response.
func (r RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest) Fields(fields []string) RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest {
	r.fields = &fields
	return r
}

// A list of fields to exclude from the response.
func (r RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest) ExcludeFields(excludeFields []string) RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest {
	r.excludeFields = &excludeFields
	return r
}

func (r RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest) Execute() (*MyPermissionsResponse, *http.Response, error) {
	return r.ApiService.RepositoriesPythonPythonMyPermissionsExecute(r)
}

/*
RepositoriesPythonPythonMyPermissions List user permissions

List permissions available to the current user on this object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pythonPythonRepositoryHref
 @return RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest
*/
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonMyPermissions(ctx context.Context, pythonPythonRepositoryHref string) RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest {
	return RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest{
		ApiService: a,
		ctx: ctx,
		pythonPythonRepositoryHref: pythonPythonRepositoryHref,
...
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonMyPermissionsExecute(r RepositoriesPythonAPIRepositoriesPythonPythonMyPermissionsRequest) (*MyPermissionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoriesPythonAPIService.RepositoriesPythonPythonMyPermissions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type RepositoriesPythonAPIRepositoriesPythonPythonRemoveRoleRequest struct {
	ctx context.Context
	ApiService *RepositoriesPythonAPIService
	pythonPythonRepositoryHref string
	nestedRole *NestedRole
...
func (r RepositoriesPythonAPIRepositoriesPythonPythonRemoveRoleRequest) Execute() (*NestedRoleResponse, *http.Response, error) {
	return r.ApiService.RepositoriesPythonPythonRemoveRoleExecute(r)
}

/*
RepositoriesPythonPythonRemoveRole Remove a role

Remove a role for this object from users/groups.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pythonPythonRepositoryHref
 @return RepositoriesPythonAPIRepositoriesPythonPythonRemoveRoleRequest
*/
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonRemoveRole(ctx context.Context, pythonPythonRepositoryHref string) RepositoriesPythonAPIRepositoriesPythonPythonRemoveRoleRequest {
	return RepositoriesPythonAPIRepositoriesPythonPythonRemoveRoleRequest{
		ApiService: a,
		ctx: ctx,
		pythonPythonRepositoryHref: pythonPythonRepositoryHref,
...
// Execute executes the request
//  @return NestedRoleResponse
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonRemoveRoleExecute(r RepositoriesPythonAPIRepositoriesPythonPythonRemoveRoleRequest) (*NestedRoleResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoriesPythonAPIService.RepositoriesPythonPythonRemoveRole")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type RepositoriesPythonAPIRepositoriesPythonPythonSetLabelRequest struct {
	ctx context.Context
	ApiService *RepositoriesPythonAPIService
	pythonPythonRepositoryHref string
	setLabel *SetLabel
...
func (r RepositoriesPythonAPIRepositoriesPythonPythonSetLabelRequest) Execute() (*SetLabelResponse, *http.Response, error) {
	return r.ApiService.RepositoriesPythonPythonSetLabelExecute(r)
}

/*
RepositoriesPythonPythonSetLabel Set a label

Set a single pulp_label on the object to a specific value or null.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pythonPythonRepositoryHref
 @return RepositoriesPythonAPIRepositoriesPythonPythonSetLabelRequest
*/
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonSetLabel(ctx context.Context, pythonPythonRepositoryHref string) RepositoriesPythonAPIRepositoriesPythonPythonSetLabelRequest {
	return RepositoriesPythonAPIRepositoriesPythonPythonSetLabelRequest{
		ApiService: a,
		ctx: ctx,
		pythonPythonRepositoryHref: pythonPythonRepositoryHref,
...
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonSetLabelExecute(r RepositoriesPythonAPIRepositoriesPythonPythonSetLabelRequest) (*SetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoriesPythonAPIService.RepositoriesPythonPythonSetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Trigger an asynchronous task to sync python content. The sync task will retrieve Pythoncontent from the specified `Remote` and update the specified `Respository`, creating anew  `RepositoryVersion`.
...
type RepositoriesPythonAPIRepositoriesPythonPythonUnsetLabelRequest struct {
	ctx context.Context
	ApiService *RepositoriesPythonAPIService
	pythonPythonRepositoryHref string
...
func (r RepositoriesPythonAPIRepositoriesPythonPythonUnsetLabelRequest) Execute() (*UnsetLabelResponse, *http.Response, error) {
	return r.ApiService.RepositoriesPythonPythonUnsetLabelExecute(r)
}

/*
RepositoriesPythonPythonUnsetLabel Unset a label

Unset a single pulp_label on the object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pythonPythonRepositoryHref
 @return RepositoriesPythonAPIRepositoriesPythonPythonUnsetLabelRequest
*/
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonUnsetLabel(ctx context.Context, pythonPythonRepositoryHref string) RepositoriesPythonAPIRepositoriesPythonPythonUnsetLabelRequest {
	return RepositoriesPythonAPIRepositoriesPythonPythonUnsetLabelRequest{
		ApiService: a,
		ctx: ctx,
		pythonPythonRepositoryHref: pythonPythonRepositoryHref,
...
func (a *RepositoriesPythonAPIService) RepositoriesPythonPythonUnsetLabelExecute(r RepositoriesPythonAPIRepositoriesPythonPythonUnsetLabelRequest) (*UnsetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoriesPythonAPIService.RepositoriesPythonPythonUnsetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
