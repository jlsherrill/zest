...
type _HuggingFaceHuggingFaceRepository HuggingFaceHuggingFaceRepository
...
func NewHuggingFaceHuggingFaceRepository(name string) *HuggingFaceHuggingFaceRepository {
	this := HuggingFaceHuggingFaceRepository{}
	this.Name = name
	return &this
}
...
func (o *HuggingFaceHuggingFaceRepository) SetDescriptionNil() {
...
func (o *HuggingFaceHuggingFaceRepository) SetRetainRepoVersionsNil() {
...
func (o *HuggingFaceHuggingFaceRepository) SetRemoteNil() {
	o.Remote.Set(nil)
}
...
func (o HuggingFaceHuggingFaceRepository) MarshalJSON() ([]byte, error) {
...
func (o HuggingFaceHuggingFaceRepository) ToMap() (map[string]interface{}, error) {
...
func (o *HuggingFaceHuggingFaceRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varHuggingFaceHuggingFaceRepository := _HuggingFaceHuggingFaceRepository{}

	err = json.Unmarshal(data, &varHuggingFaceHuggingFaceRepository)

	if err != nil {
		return err
	}

	*o = HuggingFaceHuggingFaceRepository(varHuggingFaceHuggingFaceRepository)
...
type NullableHuggingFaceHuggingFaceRepository struct {
	value *HuggingFaceHuggingFaceRepository
	isSet bool
}

func (v NullableHuggingFaceHuggingFaceRepository) Get() *HuggingFaceHuggingFaceRepository {
	return v.value
}

func (v *NullableHuggingFaceHuggingFaceRepository) Set(val *HuggingFaceHuggingFaceRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableHuggingFaceHuggingFaceRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableHuggingFaceHuggingFaceRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHuggingFaceHuggingFaceRepository(val *HuggingFaceHuggingFaceRepository) *NullableHuggingFaceHuggingFaceRepository {
	return &NullableHuggingFaceHuggingFaceRepository{value: val, isSet: true}
}

func (v NullableHuggingFaceHuggingFaceRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHuggingFaceHuggingFaceRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
