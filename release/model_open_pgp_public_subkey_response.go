...
// checks if the OpenPGPPublicSubkeyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenPGPPublicSubkeyResponse{}

// OpenPGPPublicSubkeyResponse Base serializer for use with [pulpcore.app.models.Model][]This ensures that all Serializers provide values for the 'pulp_href` field.The class provides a default for the ``ref_name`` attribute in theModelSerializers's ``Meta`` class. This ensures that the OpenAPI definitionsof plugins are namespaced properly.
type OpenPGPPublicSubkeyResponse struct {
...
type _OpenPGPPublicSubkeyResponse OpenPGPPublicSubkeyResponse
...
func NewOpenPGPPublicSubkeyResponse(fingerprint string, created time.Time) *OpenPGPPublicSubkeyResponse {
	this := OpenPGPPublicSubkeyResponse{}
...
func (o OpenPGPPublicSubkeyResponse) MarshalJSON() ([]byte, error) {
...
func (o OpenPGPPublicSubkeyResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OpenPGPPublicSubkeyResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenPGPPublicSubkeyResponse := _OpenPGPPublicSubkeyResponse{}

	err = json.Unmarshal(data, &varOpenPGPPublicSubkeyResponse)

	if err != nil {
		return err
	}

	*o = OpenPGPPublicSubkeyResponse(varOpenPGPPublicSubkeyResponse)
...
type NullableOpenPGPPublicSubkeyResponse struct {
	value *OpenPGPPublicSubkeyResponse
	isSet bool
}

func (v NullableOpenPGPPublicSubkeyResponse) Get() *OpenPGPPublicSubkeyResponse {
	return v.value
}

func (v *NullableOpenPGPPublicSubkeyResponse) Set(val *OpenPGPPublicSubkeyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenPGPPublicSubkeyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenPGPPublicSubkeyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenPGPPublicSubkeyResponse(val *OpenPGPPublicSubkeyResponse) *NullableOpenPGPPublicSubkeyResponse {
	return &NullableOpenPGPPublicSubkeyResponse{value: val, isSet: true}
}

func (v NullableOpenPGPPublicSubkeyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenPGPPublicSubkeyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
