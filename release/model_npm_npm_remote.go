...
type _NpmNpmRemote NpmNpmRemote
...
func (o *NpmNpmRemote) SetCaCertNil() {
	o.CaCert.Set(nil)
}
...
func (o *NpmNpmRemote) SetClientCertNil() {
...
func (o *NpmNpmRemote) SetClientKeyNil() {
	o.ClientKey.Set(nil)
}
...
func (o *NpmNpmRemote) SetProxyUrlNil() {
	o.ProxyUrl.Set(nil)
}
...
func (o *NpmNpmRemote) SetProxyUsernameNil() {
...
func (o *NpmNpmRemote) SetProxyPasswordNil() {
...
func (o *NpmNpmRemote) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o *NpmNpmRemote) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *NpmNpmRemote) SetMaxRetriesNil() {
...
func (o *NpmNpmRemote) SetTotalTimeoutNil() {
...
func (o *NpmNpmRemote) SetConnectTimeoutNil() {
...
func (o *NpmNpmRemote) SetSockConnectTimeoutNil() {
...
func (o *NpmNpmRemote) SetSockReadTimeoutNil() {
...
func (o *NpmNpmRemote) SetRateLimitNil() {
	o.RateLimit.Set(nil)
}
...
func (o NpmNpmRemote) MarshalJSON() ([]byte, error) {
...
func (o NpmNpmRemote) ToMap() (map[string]interface{}, error) {
...
func (o *NpmNpmRemote) UnmarshalJSON(data []byte) (err error) {
	...
	varNpmNpmRemote := _NpmNpmRemote{}

	err = json.Unmarshal(data, &varNpmNpmRemote)

	if err != nil {
		return err
	}

	*o = NpmNpmRemote(varNpmNpmRemote)
...
type NullableNpmNpmRemote struct {
	value *NpmNpmRemote
	isSet bool
}

func (v NullableNpmNpmRemote) Get() *NpmNpmRemote {
	return v.value
}

func (v *NullableNpmNpmRemote) Set(val *NpmNpmRemote) {
	v.value = val
	v.isSet = true
}

func (v NullableNpmNpmRemote) IsSet() bool {
	return v.isSet
}

func (v *NullableNpmNpmRemote) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNpmNpmRemote(val *NpmNpmRemote) *NullableNpmNpmRemote {
	return &NullableNpmNpmRemote{value: val, isSet: true}
}

func (v NullableNpmNpmRemote) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNpmNpmRemote) UnmarshalJSON(src []byte) error {
	v.isSet = true
