...
------------- | ------------- | -------------
[**ContentguardsCertguardX509Create**](ContentguardsX509API.md#ContentguardsCertguardX509Create) | **Post** /api/pulp/{pulp_domain}/api/v3/contentguards/certguard/x509/ | Create a x509 cert guard
...
[**ContentguardsCertguardX509List**](ContentguardsX509API.md#ContentguardsCertguardX509List) | **Get** /api/pulp/{pulp_domain}/api/v3/contentguards/certguard/x509/ | List x509 cert guards
