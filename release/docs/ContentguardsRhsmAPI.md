...
------------- | ------------- | -------------
[**ContentguardsCertguardRhsmCreate**](ContentguardsRhsmAPI.md#ContentguardsCertguardRhsmCreate) | **Post** /api/pulp/{pulp_domain}/api/v3/contentguards/certguard/rhsm/ | Create a rhsm cert guard
...
[**ContentguardsCertguardRhsmList**](ContentguardsRhsmAPI.md#ContentguardsCertguardRhsmList) | **Get** /api/pulp/{pulp_domain}/api/v3/contentguards/certguard/rhsm/ | List rhsm cert guards
