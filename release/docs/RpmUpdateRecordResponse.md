...
`func (o *RpmUpdateRecordResponse) GetVulnReport() string`

GetVulnReport returns the VulnReport field if non-nil, zero value otherwise.

### GetVulnReportOk

`func (o *RpmUpdateRecordResponse) GetVulnReportOk() (*string, bool)`
...
`func (o *RpmUpdateRecordResponse) SetVulnReport(v string)`

SetVulnReport sets VulnReport field to given value.

### HasVulnReport

`func (o *RpmUpdateRecordResponse) HasVulnReport() bool`
