...
`func (o *RpmPackageCategoryResponse) GetVulnReport() string`

GetVulnReport returns the VulnReport field if non-nil, zero value otherwise.

### GetVulnReportOk

`func (o *RpmPackageCategoryResponse) GetVulnReportOk() (*string, bool)`
...
`func (o *RpmPackageCategoryResponse) SetVulnReport(v string)`

SetVulnReport sets VulnReport field to given value.

### HasVulnReport

`func (o *RpmPackageCategoryResponse) HasVulnReport() bool`
