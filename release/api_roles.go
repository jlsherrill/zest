...
func (r RolesAPIRolesListRequest) PrnIn(prnIn []string) RolesAPIRolesListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (a *RolesAPIService) RolesListExecute(r RolesAPIRolesListRequest) (*PaginatedRoleResponseList, *http.Response, error) {
	...
	if r.containsPermission != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
                               parameterAddToHeaderOrQuery(localVarQueryParams, "contains_permission", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "contains_permission", t, "form", "multi")
		}
	}
	...
	if r.descriptionContains != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "description__contains", r.descriptionContains, "form", "")
	}
	if r.descriptionIcontains != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "description__icontains", r.descriptionIcontains, "form", "")
	}
	if r.descriptionIexact != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "description__iexact", r.descriptionIexact, "form", "")
	}
	if r.forObjectType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "for_object_type", r.forObjectType, "form", "")
	}
	if r.limit != nil {
