...
// checks if the FileFileRemoteResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileFileRemoteResponse{}

// FileFileRemoteResponse Serializer for File Remotes.
type FileFileRemoteResponse struct {
...
func (o *FileFileRemoteResponse) SetCaCertNil() {
	o.CaCert.Set(nil)
}
...
func (o *FileFileRemoteResponse) SetClientCertNil() {
...
func (o *FileFileRemoteResponse) SetProxyUrlNil() {
	o.ProxyUrl.Set(nil)
}
...
func (o *FileFileRemoteResponse) SetMaxRetriesNil() {
...
func (o *FileFileRemoteResponse) SetTotalTimeoutNil() {
...
func (o *FileFileRemoteResponse) SetConnectTimeoutNil() {
...
func (o *FileFileRemoteResponse) SetSockConnectTimeoutNil() {
...
func (o *FileFileRemoteResponse) SetSockReadTimeoutNil() {
...
func (o *FileFileRemoteResponse) SetDownloadConcurrencyNil() {
...
func (o *FileFileRemoteResponse) SetRateLimitNil() {
	o.RateLimit.Set(nil)
}
...
func (o FileFileRemoteResponse) MarshalJSON() ([]byte, error) {
...
func (o FileFileRemoteResponse) ToMap() (map[string]interface{}, error) {
...
func (o *FileFileRemoteResponse) UnmarshalJSON(data []byte) (err error) {
...
type NullableFileFileRemoteResponse struct {
	value *FileFileRemoteResponse
	isSet bool
}

func (v NullableFileFileRemoteResponse) Get() *FileFileRemoteResponse {
	return v.value
}

func (v *NullableFileFileRemoteResponse) Set(val *FileFileRemoteResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileFileRemoteResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileFileRemoteResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileFileRemoteResponse(val *FileFileRemoteResponse) *NullableFileFileRemoteResponse {
	return &NullableFileFileRemoteResponse{value: val, isSet: true}
}

func (v NullableFileFileRemoteResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileFileRemoteResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
