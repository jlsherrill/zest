...
/*
RepositoriesFileFileAddRole Add a role
...
*/
func (a *RepositoriesFileAPIService) RepositoriesFileFileCreate(ctx context.Context, pulpDomain string) RepositoriesFileAPIRepositoriesFileFileCreateRequest {
	return RepositoriesFileAPIRepositoriesFileFileCreateRequest{
		ApiService: a,
		ctx: ctx,
...
// Filter results where name matches value
func (r RepositoriesFileAPIRepositoriesFileFileListRequest) NameIexact(nameIexact string) RepositoriesFileAPIRepositoriesFileFileListRequest {
...
func (r RepositoriesFileAPIRepositoriesFileFileListRequest) NameIregex(nameIregex string) RepositoriesFileAPIRepositoriesFileFileListRequest {
	r.nameIregex = &nameIregex
	return r
}

// Filter results where name starts with value
func (r RepositoriesFileAPIRepositoriesFileFileListRequest) NameIstartswith(nameIstartswith string) RepositoriesFileAPIRepositoriesFileFileListRequest {
	r.nameIstartswith = &nameIstartswith
	return r
}

// Filter results where name matches regex value
func (r RepositoriesFileAPIRepositoriesFileFileListRequest) NameRegex(nameRegex string) RepositoriesFileAPIRepositoriesFileFileListRequest {
...
func (r RepositoriesFileAPIRepositoriesFileFileListRequest) PrnIn(prnIn []string) RepositoriesFileAPIRepositoriesFileFileListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (r RepositoriesFileAPIRepositoriesFileFileListRequest) Q(q string) RepositoriesFileAPIRepositoriesFileFileListRequest {
	r.q = &q
	return r
}
...
*/
func (a *RepositoriesFileAPIService) RepositoriesFileFileList(ctx context.Context, pulpDomain string) RepositoriesFileAPIRepositoriesFileFileListRequest {
	return RepositoriesFileAPIRepositoriesFileFileListRequest{
		ApiService: a,
		ctx: ctx,
		pulpDomain: pulpDomain,
...
/*
RepositoriesFileFileListRoles List roles
...
/*
RepositoriesFileFileMyPermissions List user permissions
...
/*
RepositoriesFileFileRemoveRole Remove a role
...
type RepositoriesFileAPIRepositoriesFileFileSetLabelRequest struct {
	ctx context.Context
	ApiService *RepositoriesFileAPIService
	fileFileRepositoryHref string
	setLabel *SetLabel
...
func (r RepositoriesFileAPIRepositoriesFileFileSetLabelRequest) Execute() (*SetLabelResponse, *http.Response, error) {
	return r.ApiService.RepositoriesFileFileSetLabelExecute(r)
}

/*
RepositoriesFileFileSetLabel Set a label

Set a single pulp_label on the object to a specific value or null.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param fileFileRepositoryHref
 @return RepositoriesFileAPIRepositoriesFileFileSetLabelRequest
*/
func (a *RepositoriesFileAPIService) RepositoriesFileFileSetLabel(ctx context.Context, fileFileRepositoryHref string) RepositoriesFileAPIRepositoriesFileFileSetLabelRequest {
	return RepositoriesFileAPIRepositoriesFileFileSetLabelRequest{
		ApiService: a,
		ctx: ctx,
		fileFileRepositoryHref: fileFileRepositoryHref,
...
func (a *RepositoriesFileAPIService) RepositoriesFileFileSetLabelExecute(r RepositoriesFileAPIRepositoriesFileFileSetLabelRequest) (*SetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoriesFileAPIService.RepositoriesFileFileSetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type RepositoriesFileAPIRepositoriesFileFileUnsetLabelRequest struct {
	ctx context.Context
	ApiService *RepositoriesFileAPIService
	fileFileRepositoryHref string
...
func (r RepositoriesFileAPIRepositoriesFileFileUnsetLabelRequest) Execute() (*UnsetLabelResponse, *http.Response, error) {
	return r.ApiService.RepositoriesFileFileUnsetLabelExecute(r)
}

/*
RepositoriesFileFileUnsetLabel Unset a label

Unset a single pulp_label on the object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param fileFileRepositoryHref
 @return RepositoriesFileAPIRepositoriesFileFileUnsetLabelRequest
*/
func (a *RepositoriesFileAPIService) RepositoriesFileFileUnsetLabel(ctx context.Context, fileFileRepositoryHref string) RepositoriesFileAPIRepositoriesFileFileUnsetLabelRequest {
	return RepositoriesFileAPIRepositoriesFileFileUnsetLabelRequest{
		ApiService: a,
		ctx: ctx,
		fileFileRepositoryHref: fileFileRepositoryHref,
...
func (a *RepositoriesFileAPIService) RepositoriesFileFileUnsetLabelExecute(r RepositoriesFileAPIRepositoriesFileFileUnsetLabelRequest) (*UnsetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoriesFileAPIService.RepositoriesFileFileUnsetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
