...
func (o *PythonPythonPackageContentResponse) SetMetadataSha256Nil() {
...
func (o *PythonPythonPackageContentResponse) UnmarshalJSON(data []byte) (err error) {
	varPythonPythonPackageContentResponse := _PythonPythonPackageContentResponse{}

	err = json.Unmarshal(data, &varPythonPythonPackageContentResponse)
