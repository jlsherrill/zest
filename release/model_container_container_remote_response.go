...
func (o *ContainerContainerRemoteResponse) SetCaCertNil() {
	o.CaCert.Set(nil)
}
...
func (o *ContainerContainerRemoteResponse) SetClientCertNil() {
...
func (o *ContainerContainerRemoteResponse) SetProxyUrlNil() {
	o.ProxyUrl.Set(nil)
}
...
func (o *ContainerContainerRemoteResponse) SetMaxRetriesNil() {
...
func (o *ContainerContainerRemoteResponse) SetTotalTimeoutNil() {
...
func (o *ContainerContainerRemoteResponse) SetConnectTimeoutNil() {
...
func (o *ContainerContainerRemoteResponse) SetSockConnectTimeoutNil() {
...
func (o *ContainerContainerRemoteResponse) SetSockReadTimeoutNil() {
...
func (o *ContainerContainerRemoteResponse) SetRateLimitNil() {
	o.RateLimit.Set(nil)
}
...
func (o *ContainerContainerRemoteResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varContainerContainerRemoteResponse)
