...
// checks if the PythonPackageContentUpload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PythonPackageContentUpload{}

// PythonPackageContentUpload A serializer for requests to synchronously upload Python packages.
type PythonPackageContentUpload struct {
...
type _PythonPackageContentUpload PythonPackageContentUpload
...
func NewPythonPackageContentUpload() *PythonPackageContentUpload {
	this := PythonPackageContentUpload{}
	var sha256 string = ""
	this.Sha256 = &sha256
	return &this
}
...
func (o *PythonPackageContentUpload) SetMetadataSha256Nil() {
...
func (o PythonPackageContentUpload) MarshalJSON() ([]byte, error) {
...
func (o PythonPackageContentUpload) ToMap() (map[string]interface{}, error) {
...
func (o *PythonPackageContentUpload) UnmarshalJSON(data []byte) (err error) {
	varPythonPackageContentUpload := _PythonPackageContentUpload{}

	err = json.Unmarshal(data, &varPythonPackageContentUpload)

	if err != nil {
		return err
	}

	*o = PythonPackageContentUpload(varPythonPackageContentUpload)
...
type NullablePythonPackageContentUpload struct {
	value *PythonPackageContentUpload
	isSet bool
}

func (v NullablePythonPackageContentUpload) Get() *PythonPackageContentUpload {
	return v.value
}

func (v *NullablePythonPackageContentUpload) Set(val *PythonPackageContentUpload) {
	v.value = val
	v.isSet = true
}

func (v NullablePythonPackageContentUpload) IsSet() bool {
	return v.isSet
}

func (v *NullablePythonPackageContentUpload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePythonPackageContentUpload(val *PythonPackageContentUpload) *NullablePythonPackageContentUpload {
	return &NullablePythonPackageContentUpload{value: val, isSet: true}
}

func (v NullablePythonPackageContentUpload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePythonPackageContentUpload) UnmarshalJSON(src []byte) error {
	v.isSet = true
