...
// checks if the PatchedcontainerContainerPullThroughRemote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedcontainerContainerPullThroughRemote{}

// PatchedcontainerContainerPullThroughRemote A serializer for a remote used in the pull-through distribution.
type PatchedcontainerContainerPullThroughRemote struct {
...
type _PatchedcontainerContainerPullThroughRemote PatchedcontainerContainerPullThroughRemote
...
func NewPatchedcontainerContainerPullThroughRemote() *PatchedcontainerContainerPullThroughRemote {
	this := PatchedcontainerContainerPullThroughRemote{}
...
func (o *PatchedcontainerContainerPullThroughRemote) SetCaCertNil() {
	o.CaCert.Set(nil)
}
...
func (o *PatchedcontainerContainerPullThroughRemote) SetClientCertNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetClientKeyNil() {
	o.ClientKey.Set(nil)
}
...
func (o *PatchedcontainerContainerPullThroughRemote) SetProxyUrlNil() {
	o.ProxyUrl.Set(nil)
}
...
func (o *PatchedcontainerContainerPullThroughRemote) SetProxyUsernameNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetProxyPasswordNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o *PatchedcontainerContainerPullThroughRemote) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *PatchedcontainerContainerPullThroughRemote) SetMaxRetriesNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetTotalTimeoutNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetConnectTimeoutNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetSockConnectTimeoutNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetSockReadTimeoutNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetDownloadConcurrencyNil() {
...
func (o *PatchedcontainerContainerPullThroughRemote) SetRateLimitNil() {
	o.RateLimit.Set(nil)
}
...
func (o PatchedcontainerContainerPullThroughRemote) MarshalJSON() ([]byte, error) {
...
func (o PatchedcontainerContainerPullThroughRemote) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedcontainerContainerPullThroughRemote) UnmarshalJSON(data []byte) (err error) {
	varPatchedcontainerContainerPullThroughRemote := _PatchedcontainerContainerPullThroughRemote{}

	err = json.Unmarshal(data, &varPatchedcontainerContainerPullThroughRemote)

	if err != nil {
		return err
	}

	*o = PatchedcontainerContainerPullThroughRemote(varPatchedcontainerContainerPullThroughRemote)
...
type NullablePatchedcontainerContainerPullThroughRemote struct {
	value *PatchedcontainerContainerPullThroughRemote
	isSet bool
}

func (v NullablePatchedcontainerContainerPullThroughRemote) Get() *PatchedcontainerContainerPullThroughRemote {
	return v.value
}

func (v *NullablePatchedcontainerContainerPullThroughRemote) Set(val *PatchedcontainerContainerPullThroughRemote) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedcontainerContainerPullThroughRemote) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedcontainerContainerPullThroughRemote) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedcontainerContainerPullThroughRemote(val *PatchedcontainerContainerPullThroughRemote) *NullablePatchedcontainerContainerPullThroughRemote {
	return &NullablePatchedcontainerContainerPullThroughRemote{value: val, isSet: true}
}

func (v NullablePatchedcontainerContainerPullThroughRemote) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedcontainerContainerPullThroughRemote) UnmarshalJSON(src []byte) error {
	v.isSet = true
