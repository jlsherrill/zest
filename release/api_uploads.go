...
func (r UploadsAPIUploadsListRequest) PrnIn(prnIn []string) UploadsAPIUploadsListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (a *UploadsAPIService) UploadsListExecute(r UploadsAPIUploadsListRequest) (*PaginatedUploadResponseList, *http.Response, error) {
	...
	if r.sizeGt != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "size__gt", r.sizeGt, "form", "")
	}
	if r.sizeLt != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "size__lt", r.sizeLt, "form", "")
	}
	if r.sizeRange != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "size__range", r.sizeRange, "form", "csv")
	}
	if r.fields != nil {
		t := *r.fields
