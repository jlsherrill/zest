...
// PatchedRBACContentGuard Base class for content guard serializers.
...
func (o *PatchedRBACContentGuard) UnmarshalJSON(data []byte) (err error) {
	varPatchedRBACContentGuard := _PatchedRBACContentGuard{}

	err = json.Unmarshal(data, &varPatchedRBACContentGuard)
