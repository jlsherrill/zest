...
/*
PublicationsFileFileAddRole Add a role
...
*/
func (a *PublicationsFileAPIService) PublicationsFileFileCreate(ctx context.Context, pulpDomain string) PublicationsFileAPIPublicationsFileFileCreateRequest {
	return PublicationsFileAPIPublicationsFileFileCreateRequest{
		ApiService: a,
		ctx: ctx,
...
func (r PublicationsFileAPIPublicationsFileFileListRequest) Checkpoint(checkpoint bool) PublicationsFileAPIPublicationsFileFileListRequest {
...
// Multiple values may be separated by commas.
func (r PublicationsFileAPIPublicationsFileFileListRequest) PrnIn(prnIn []string) PublicationsFileAPIPublicationsFileFileListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (r PublicationsFileAPIPublicationsFileFileListRequest) PulpCreatedIsnull(pulpCreatedIsnull bool) PublicationsFileAPIPublicationsFileFileListRequest {
...
*/
func (a *PublicationsFileAPIService) PublicationsFileFileList(ctx context.Context, pulpDomain string) PublicationsFileAPIPublicationsFileFileListRequest {
	return PublicationsFileAPIPublicationsFileFileListRequest{
		ApiService: a,
		ctx: ctx,
		pulpDomain: pulpDomain,
...
/*
PublicationsFileFileListRoles List roles
...
/*
PublicationsFileFileMyPermissions List user permissions
...
/*
PublicationsFileFileRemoveRole Remove a role
